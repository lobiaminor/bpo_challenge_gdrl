...
rhandle = open("./bpi2017/BPI Challenge 2017.csv", "r")
whandle = open("./bpi2017/BPI Challenge 2017 - lifecycle expanded.csv", "w")
...
log = pd.read_csv("./bpi2017/BPI Challenge 2017 - lifecycle expanded.csv")
log = log.sort_values(by=['Case ID', 'Start Timestamp'])
log.to_csv("./bpi2017/BPI Challenge 2017 - sorted.csv", index=False)


# %% Now we merge (start|resume) / (complete|suspend) combinations

rhandle = open("./bpi2017/BPI Challenge 2017 - sorted.csv", "r")
whandle = open("./bpi2017/BPI Challenge 2017 - clean.csv", "w")
